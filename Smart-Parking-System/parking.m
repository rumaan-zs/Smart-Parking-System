...
%To read background image or initial image of parking area
...
totalslot=36;    %Given Total number of slot in the parking area.
 ...
 subplot(2,2,3) , imshow(mat2gray(bg)), title ('Backgroung Frame ');
...
numberofcarsa = size(blobMeasurementsa, 1);
 ...
 subplot(2,2,3) , imshow(mat2gray(bgb)), title ('Background Frame ');
